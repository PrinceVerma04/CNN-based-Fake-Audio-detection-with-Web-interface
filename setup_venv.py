...
# Load environment from .env (place .env in the same folder as app.py)
load_dotenv()
...
if not openai_key:
    raise RuntimeError(
        "OPENAI_API_KEY not found. Create a .env file next to app.py with:\n"
        "OPENAI_API_KEY=AIzaSyAbypUMToSJbV1cT0uKeWT96Er3lDFyVOI"
    )
...
model_path = "C:\Users\saish\OneDrive\Desktop\CNN BASED Approach\CNN based aproach\models\cnn_v2.pt"
